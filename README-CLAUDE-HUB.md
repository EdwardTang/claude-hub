...
> **Note**: This is the Oppie fork of Claude-Hub, featuring advanced AI planning with MCTS and LangGraph integration. For the original Claude-Hub documentation, see [README-CLAUDE-HUB.md](./README-CLAUDE-HUB.md).
